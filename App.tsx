  ...
  const renderContent = () => {
    switch (currentRoute) {
      ...
      default:
        return (
          <>
            <div className="relative z-10 bg-dark-base mb-[85vh] md:mb-[60vh] shadow-2xl shadow-black transition-all">
              <Hero />
              <Services />
              <Metrics />
              <CaseStudies />
            ...
            <div className="fixed bottom-0 left-0 w-full h-[85vh] md:h-[60vh] z-0">
              <Footer />
            </div>
          </>
        );
