...
const CaseStudies: React.FC = () => {
  ...
  return (
    <section 
        ...
        className="relative py-20 md:py-32 bg-dark-base border-t border-dark-border dark:border-white/5 overflow-hidden cursor-auto md:cursor-none z-20 transition-colors duration-500"
    >
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
            ...
            <div className="mt-16 md:mt-24 flex justify-center">
                 <button className="text-light-dim hover:text-light-neutral dark:hover:text-white font-mono text-xs uppercase tracking-[0.2em] border-b border-transparent hover:border-teal-primary pb-1 transition-all">
