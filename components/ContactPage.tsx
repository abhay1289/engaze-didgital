...
const ContactPage: React.FC = () => {
    ...
    return (
        <div className="bg-[#F8F9FB] min-h-screen text-[#0F172A] transition-colors duration-500 overflow-hidden relative selection:bg-teal-primary selection:text-white">
            <GrainOverlay />

            {/* Ambient Background Glows */}
            <div className="absolute top-[-20%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-teal-primary/5 blur-[150px] mix-blend-screen pointer-events-none" />
            <div className="absolute bottom-[-20%] right-[-10%] w-[40vw] h-[40vw] rounded-full bg-teal-primary/5 blur-[120px] mix-blend-screen pointer-events-none" />
            ...
            <section className="pt-32 pb-20 px-6 md:px-12 max-w-[1800px] mx-auto min-h-screen flex flex-col justify-center relative z-10 text-left">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 lg:gap-12 items-start text-left">
                    ...
                    >
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter mb-8 leading-[0.9] text-left uppercase text-[#0F172A]">
                            GET IN <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-primary to-teal-secondary">TOUCH.</span>
                        </h1>
                        <p className="text-base md:text-lg text-slate-500 leading-relaxed mb-16 max-w-md font-light text-left">
                            Tell us about your project and goals. We'll get back to you within 24 hours.
                        </p>

                        <div className="space-y-8 text-left border-t border-slate-200 pt-12">
                            <div className="flex items-start gap-6 group text-left cursor-pointer">
                                <div className="p-4 rounded-full border border-slate-200 bg-slate-50 group-hover:border-teal-primary/50 group-hover:bg-teal-primary/10 transition-all duration-500 text-teal-primary mt-1">
                                    <Mail size={24} />
                                </div>
                                <div className="text-left flex flex-col">
                                    <span className="font-mono text-[10px] uppercase tracking-widest text-slate-300 mb-2">Email</span>
                                    <a href="mailto:hello@engazedigital.com" className="text-xl font-bold text-[#0F172A] group-hover:text-teal-primary transition-colors text-left flex items-center gap-3">
                            ...
                            <div className="flex items-start gap-6 group text-left mt-8">
                                <div className="p-4 rounded-full border border-slate-200 bg-slate-50 text-slate-500 mt-1">
                                    <MapPin size={24} />
                                </div>
                                <div className="text-left flex flex-col">
                                    <span className="font-mono text-[10px] uppercase tracking-widest text-slate-300 mb-2">Location</span>
                    ...
                    <motion.div
                        ...
                        className="lg:col-span-7 bg-white p-8 md:p-16 rounded-[2rem] border border-slate-200 shadow-lg relative overflow-hidden text-left group"
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10 relative z-10 text-left">
                            ...
                            <div className="relative text-left flex flex-col mt-4">
                                ...
                                <textarea
                                    ...
                                    onBlur={() => setFocusedField(null)}
                                    className="w-full bg-transparent border-b border-slate-200 py-3 text-base focus:outline-none focus:border-teal-primary transition-all text-[#0F172A] resize-none placeholder:text-slate-300 text-left"
                                    placeholder="Detail your objectives..."
                                />
                            </div>

                            <div className="pt-8 text-left mt-12 flex items-center justify-between border-t border-slate-200 pt-10">
                                <span className="hidden md:inline-block text-slate-300 font-mono text-[10px] uppercase tracking-widest">We typically respond within <span className="text-teal-primary/80">24 hours</span></span>
