                        ...
                        <form onSubmit={handleSubmit} className="space-y-10 relative z-10 text-left">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-left">
                                <div className="relative text-left flex flex-col">
                                    ...
                                    <input type="text" name="name" required onFocus={() => setFocusedField('name')} onBlur={() => setFocusedField(null)} className="w-full bg-transparent border-b border-white/20 py-3 text-base focus:outline-none focus:border-teal-primary transition-all text-white placeholder:text-white/10 text-left" placeholder="Enter your name" />
                                </div>
                                <div className="relative text-left flex flex-col">
                                    ...
                                    <input type="email" name="email" required onFocus={() => setFocusedField('email')} onBlur={() => setFocusedField(null)} className="w-full bg-transparent border-b border-white/20 py-3 text-base focus:outline-none focus:border-teal-primary transition-all text-white placeholder:text-white/10 text-left" placeholder="name@domain.com" />
                                </div>
                            </div>
                            ...
                            <div className="relative text-left flex flex-col mt-4">
                                ...
                                <input type="text" name="company" onFocus={() => setFocusedField('company')} onBlur={() => setFocusedField(null)} className="w-full bg-transparent border-b border-white/20 py-3 text-base focus:outline-none focus:border-teal-primary transition-all text-white placeholder:text-white/10 text-left" placeholder="Your Organization" />
                            </div>
                            ...
                            <div className="relative text-left flex flex-col mt-4">
                                ...
                                <textarea name="message" rows={5} required onFocus={() => setFocusedField('message')} onBlur={() => setFocusedField(null)} className="w-full bg-transparent border-b border-white/20 py-3 text-base focus:outline-none focus:border-teal-primary transition-all text-white resize-none placeholder:text-white/10 text-left" placeholder="Detail your objectives..." />
                            </div>
