...
const Hero: React.FC = () => {
    ...
    // Subtly transform text on scroll
    ...
    return (
        <section
            ...
            className="relative w-full h-[100dvh] bg-[#030303] overflow-hidden flex flex-col justify-center items-center"
        >
            ...
            <motion.div
                className="pointer-events-none absolute -inset-px z-20 opacity-0 transition duration-500 group-hover:opacity-100"
                style={{
            ...
            <motion.div
                ...
                className="relative z-30 flex flex-col items-center justify-center text-center w-full px-6"
            >
                {/* Premium Badge */}
                <motion.div
                ...
                >
                    <div className="relative inline-flex items-center gap-2 px-4 py-2 rounded-full border border-teal-500/20 bg-teal-500/5 backdrop-blur-xl overflow-hidden hover:bg-teal-500/10 transition-colors duration-500">
                        ...
                        <span className="font-mono text-xs uppercase tracking-[0.2em] text-teal-400">Welcome to the Next Era</span>
                        <ChevronRight className="w-4 h-4 text-teal-500 group-hover:translate-x-1 transition-transform" />
                    </div>
                </motion.div>

                {/* Typography Architecture */}
                <div className="flex flex-col items-center gap-2 md:gap-0 select-none cursor-default perspective-1000">
                    {/* Top Word */}
                    <div className="flex overflow-hidden pb-2 md:pb-4">
                        {characters.top.map((char, i) => (
                            <motion.span
                                ...
                                className="text-[16vw] md:text-[11vw] font-black leading-[0.85] tracking-tighter text-white"
                    ...
                    <div className="flex overflow-hidden">
                        {characters.bottom.map((char, i) => (
                            <motion.span
                                ...
                                className="text-[16vw] md:text-[11vw] font-black leading-[0.85] tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white via-teal-100 to-teal-600"
                                style={{ transformOrigin: "bottom center" }}
                            >
                                {char}
                            </motion.span>
                ...
                >
                    <p className="text-lg md:text-2xl text-white/50 font-light leading-relaxed tracking-wide text-center">
                ...
                <motion.div
                    ...
                    className="absolute bottom-12 md:bottom-20 z-40 w-full flex justify-center"
                >
                    <Magnetic strength={30}>
                        <button className="group relative flex items-center justify-center gap-4 px-10 py-5 bg-white text-[#030303] rounded-full text-xs font-black tracking-[0.2em] uppercase transition-all duration-500 hover:scale-[1.02] shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] overflow-hidden">
