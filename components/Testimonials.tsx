...
const Testimonials: React.FC = () => {
    ...
    return (
        <section className="py-24 md:py-32 bg-[#020202] overflow-hidden relative border-t border-white/5 selection:bg-teal-primary selection:text-white">
            <div className="max-w-[1600px] mx-auto px-6 md:px-12 relative z-10">
                <div className="mb-16 md:mb-20 flex flex-col items-center text-center">
                    <span className="inline-block px-4 py-1.5 bg-white/5 rounded-full text-teal-primary text-[10px] font-mono uppercase tracking-[0.3em] border border-white/10 mb-8">
                        Testimonials
                    </span>
            ...
            >
                <div className="absolute left-0 top-0 bottom-0 w-24 md:w-40 bg-gradient-to-r from-[#020202] to-transparent z-10 pointer-events-none" />
                <div className="absolute right-0 top-0 bottom-0 w-24 md:w-40 bg-gradient-to-l from-[#020202] to-transparent z-10 pointer-events-none" />
                ...
                >
                    {doubled.map((item, i) => (
                        <div
                            key={i}
                            className="group relative bg-[#050505] border border-white/10 rounded-2xl p-8 md:p-10 flex flex-col justify-between hover:border-teal-primary/30 transition-all duration-500 overflow-hidden text-left shrink-0"
                        ...
                        >
                            ...
                            <div className="relative z-10 flex items-center gap-4 pt-6 border-t border-white/10 mt-auto">
                                <div className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center font-mono text-white/40 group-hover:text-teal-primary group-hover:border-teal-primary/30 transition-colors text-sm uppercase">
                                    {item.author.charAt(0)}
                                </div>
                                <div className="flex flex-col">
                                    <div className="font-bold text-white text-sm leading-tight tracking-wide">{item.author}</div>
                                    <div className="text-[10px] text-teal-primary font-mono uppercase tracking-widest mt-0.5">{item.role}</div>
                                </div>
                            </div>
                        </div>
                    ))}
